...
public class ProductController {
    ...
    public List<Product> byCategoryAndPrice(@PathVariable String category,@PathVariable double price) {
        return repo.findByCategoryAndPriceGreaterThan(category, price);
    }

    @GetMapping("/or")
    public List<Product> byCategoryOrName(@RequestParam String category, @RequestParam String name) {
        return repo.findByCategoryOrName(category, name);
    }


    @GetMapping("/filter")
    public List<Product> between(@RequestParam double min, @RequestParam double max) {
